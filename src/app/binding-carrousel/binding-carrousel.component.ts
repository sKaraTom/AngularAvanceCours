...
@Component({
  selector: 'app-binding-carrousel',
  templateUrl: './binding-carrousel.component.html',
  styleUrls: ['./binding-carrousel.component.css']
})
export class BindingCarrouselComponent implements OnInit {
